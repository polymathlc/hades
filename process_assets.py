...
# 1. Floor texture
floor_im = Image.open('assets/seamless_floor.jpg').convert('RGB')
floor_im.save('assets_webp/seamless_floor.webp', 'WEBP', quality=85, method=6)

# 2. Clean text-free VFX
clean_fx_im = Image.open('assets/clean_fx.jpg')
clean_keyed = key_magenta(clean_fx_im)
clean_keyed.save('assets_webp/clean_fx.webp', 'WEBP', quality=85, method=6)

# 3. Other keyed assets
keyed_files = [
