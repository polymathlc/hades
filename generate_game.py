...
SOURCE_FILES = ['runtime.js', 'data.js', 'player.js', 'enemies.js', 'effects.js', 'world.js', 'flow.js', 'boon-effects.js', 'loop.js', 'render.js', 'startup.js']
source_root = ROOT / 'src'
html_template = (source_root / 'index.template.html').read_text(encoding='utf-8')
styles = '\n'.join((source_root / name).read_text(encoding='utf-8') for name in ['styles.css', 'runtime.css'])
